    ...
    <section class="content">
      <div class="row">
         <div class="box box-primary">
            ...
            <?php echo form_open_multipart('Assetbundles/doUpload');?>
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="assetBundleTitle" name="assetBundleTitle" placeholder="">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Tags</label>
                  <input type="text" class="form-control" id="assetBundleTags" name="assetBundleTags" placeholder="">
                </div>
                <div class="form-group">
