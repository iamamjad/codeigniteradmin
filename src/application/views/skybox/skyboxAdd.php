      ...
      <div class="row">
         <div class="box box-primary">
            <div class="box-header with-border">
               ...
               <?php echo form_open_multipart('Skybox/doUpload');
               ?>
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="skyboxTitle" name="skyboxTitle" placeholder="">
                </div>

                <div class="form-group">
                  <label for="exampleInputEmail1">Tags</label>
                  <input type="text" class="form-control" id="skyboxTags" name="skyboxTags" placeholder="">
                </div>
